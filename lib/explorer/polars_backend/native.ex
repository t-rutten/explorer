defmodule Explorer.PolarsBackend.Native do
  ...
  def s_rolling_max(_s, _window_size, _weight, _min_periods), do: err()
  def s_rolling_mean(_s, _window_size, _weight, _min_periods), do: err()
  def s_rolling_min(_s, _window_size, _weight, _min_periods), do: err()
  def s_rolling_sum(_s, _window_size, _weight, _min_periods), do: err()
